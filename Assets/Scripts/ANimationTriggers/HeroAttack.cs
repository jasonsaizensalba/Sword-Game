...
// ===== HERO ATTACK (UI Display Version) =====
public class HeroAttack : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Debug.Log($"HeroAttack initialized on {gameObject.name}");
    }

    public void HeroKatanaSlash()
    {
        Debug.Log("HeroKatanaSlash called");
        PlayAttackVideo(katanaAttackClip);
    }

    public void HeroRapierSlash()
    {
        Debug.Log("HeroRapierSlash called");
        PlayAttackVideo(rapierAttackClip);
    }

    public void HeroClaymoreSlash()
    {
        Debug.Log("HeroClaymoreSlash called");
